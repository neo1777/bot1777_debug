...
class Settings extends $pb.GeneratedMessage {
  factory Settings({
    ...
    if (enableReBuy != null) result.enableReBuy = enableReBuy;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(27, _omitFieldNames ? '' : 'enableReBuy', protoName: 'enableReBuy')
    ..hasRequiredFields = false;
  ...
  /// --- Ri-acquisto automatico ---
  @$pb.TagNumber(27)
  $core.bool get enableReBuy => $_getBF(25);
  @$pb.TagNumber(27)
  set enableReBuy($core.bool value) => $_setBool(25, value);
  @$pb.TagNumber(27)
  $core.bool hasEnableReBuy() => $_has(25);
  @$pb.TagNumber(27)
  void clearEnableReBuy() => $_clearField(27);
}
...
class BacktestResultsResponse extends $pb.GeneratedMessage {
  factory BacktestResultsResponse({
    ...
    $core.String? totalFeesStr,
    $core.int? dcaTradesCount,
  }) {
    final result = create();
    if (backtestId != null) result.backtestId = backtestId;
    ...
    if (totalFeesStr != null) result.totalFeesStr = totalFeesStr;
    if (dcaTradesCount != null) result.dcaTradesCount = dcaTradesCount;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aD(8, _omitFieldNames ? '' : 'totalFees', protoName: 'totalFees')
    ..aOS(9, _omitFieldNames ? '' : 'totalFeesStr', protoName: 'totalFeesStr')
    ..aI(10, _omitFieldNames ? '' : 'dcaTradesCount',
        protoName: 'dcaTradesCount')
    ..hasRequiredFields = false;
  ...
  /// --- Fee e DCA ---
  @$pb.TagNumber(8)
  $core.double get totalFees => $_getN(7);
  @$pb.TagNumber(8)
  set totalFees($core.double value) => $_setDouble(7, value);
  @$pb.TagNumber(8)
  $core.bool hasTotalFees() => $_has(7);
  @$pb.TagNumber(8)
  void clearTotalFees() => $_clearField(8);

  @$pb.TagNumber(9)
  $core.String get totalFeesStr => $_getSZ(8);
  @$pb.TagNumber(9)
  set totalFeesStr($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
  $core.bool hasTotalFeesStr() => $_has(8);
  @$pb.TagNumber(9)
  void clearTotalFeesStr() => $_clearField(9);

  @$pb.TagNumber(10)
  $core.int get dcaTradesCount => $_getIZ(9);
  @$pb.TagNumber(10)
  set dcaTradesCount($core.int value) => $_setSignedInt32(9, value);
  @$pb.TagNumber(10)
  $core.bool hasDcaTradesCount() => $_has(9);
  @$pb.TagNumber(10)
  void clearDcaTradesCount() => $_clearField(10);
}

class AvailableSymbolsResponse extends $pb.GeneratedMessage {
  factory AvailableSymbolsResponse({
  ...
  AvailableSymbolsResponse._();

  factory AvailableSymbolsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AvailableSymbolsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AvailableSymbolsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'trading.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AvailableSymbolsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AvailableSymbolsResponse copyWith(
          void Function(AvailableSymbolsResponse) updates) =>
      super.copyWith((message) => updates(message as AvailableSymbolsResponse))
          as AvailableSymbolsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AvailableSymbolsResponse create() => AvailableSymbolsResponse._();
  @$core.override
  AvailableSymbolsResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static AvailableSymbolsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AvailableSymbolsResponse>(create);
  static AvailableSymbolsResponse? _defaultInstance;
